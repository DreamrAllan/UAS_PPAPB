...
import com.example.uasppapballan.databinding.ItemUserBinding

class UserMovieAdapter(
    private val movies: List<com.example.uasppapballan.model.Movie>,
    private val onloveClick: (com.example.uasppapballan.model.Movie) -> Unit,
) : RecyclerView.Adapter<UserMovieAdapter.MovieViewHolder>() {

    private var onItemClickListener: ((com.example.uasppapballan.model.Movie) -> Unit)? = null

    fun setOnItemClickListener(listener: (com.example.uasppapballan.model.Movie) -> Unit) {
    ...
    inner class MovieViewHolder(private val binding: ItemUserBinding) :
        ...
        fun bind(movie: com.example.uasppapballan.model.Movie) {
